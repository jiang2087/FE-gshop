...
export function ProductIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M3 6.5V17l9 5 9-5V6.5L12 11 3 6.5z" />
      
      <path d="M12 11v11" stroke="currentColor" strokeWidth="1.5" fill="none" />
    </svg>
  );
}
...
export function DiscountIcon(props: PropsType) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m21 11-8-8H2v11l8 8Z" />
      <path d="M7 7h.01" />
    </svg>
  );
}

export function VoucherIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
