              ...
              <div className="flex xl:flex-col">
                <div className="hidden lg:flex flex-wrap items-center gap-5 py-6 px-4 sm:px-7.5 xl:px-9 border-r xl:border-r-0 xl:border-b border-gray-3">
                  <div className="max-w-[64px] w-full h-16 rounded-full overflow-hidden">
                    <Image
                      src={user?.imageUrl || "/images/user/user-01.jpg  svg"}
                      alt="user"
                      width={64}
                      height={64}
                    />
                  ...
                  <div>
                    ...
                    <p className="text-custom-xs">Customer</p>
                  </div>
                </div>
            ...
            >
              <div className="max-w-6xl mx-auto p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {/* Recent Orders */}
                  <div className="bg-white shadow text-dark-2 rounded-lg p-6">
                    <h2 className="text-lg text-dark-2 font-semibold mb-4">
                      Recent Orders
                    </h2>
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                      ...
                      {addresses
                        ...
                        .map((addr: any) => (
                          <div
                            key={addr.id}
                            className="flex items-start justify-between border-b border-gray-3 pb-4"
                          >
                            <div className="flex flex-col gap-2">
                              {/* Tên người nhận */}
                              <p className="flex items-center gap-2.5 text-custom-sm font-medium text-dark">
                                <svg
                                  className="fill-current text-dark-3"
                                  width="18"
                                  height="18"
                                  viewBox="0 0 24 24"
                                  xmlns="http://www.w3.org/2000/svg"
                              ...
                              {/* Số điện thoại */}
                              <p className="flex items-center gap-2.5 text-custom-sm text-dark">
                                <svg
                                  className="fill-current text-dark-3"
                                  width="18"
                                  height="18"
            ...
            >
              ...
              <div className="w-full bg-white shadow-1 rounded-xl">
                <div className="flex items-center justify-between py-5 px-4 sm:pl-7.5 sm:pr-6 border-b border-gray-3">
                  <p className="font-medium text-xl text-dark">Addresses</p>

                  <button
                    className="inline-flex items-center gap-1.5 text-white bg-blue py-2 px-4 rounded-md ease-out duration-200 hover:bg-blue-dark text-sm"
                ...
                <div className="p-4 sm:p-7.5">
                  {addressLoading && <p className="text-dark-4">Đang tải...</p>}
                  {!addressLoading && addresses.length === 0 && (
                    <p className="text-dark-4">Chưa có địa chỉ nào.</p>
                  )}
                      ...
                      >
                        ...
                        <div className="flex flex-row gap-2">
                          <button
                            ...
                            className="text-emerald-600 ease-out duration-200 hover:text-emerald-700 p-1 mr-2"
                          ...
                          >
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <path d="M17.65 6.35A7.958 7.958 0 0 0 12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" />
                            </svg>
                          </button>
                          <button
                            onClick={() => handleDeleteAddress(addr.id)}
                            className="text-red ease-out duration-200 hover:text-red/70 p-1"
                            title="Xóa địa chỉ"
                          >
                            <svg
                              className="fill-current"
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <path d="M13.7535 2.47502H11.5879V1.9969C11.5879 1.15315 10.9129 0.478149 10.0691 0.478149H7.90352C7.05977 0.478149 6.38477 1.15315 6.38477 1.9969V2.47502H4.21914C3.40352 2.47502 2.72852 3.15002 2.72852 3.96565V4.8094C2.72852 5.42815 3.09414 5.9344 3.62852 6.1594L4.07852 15.4688C4.13477 16.6219 5.09102 17.5219 6.24414 17.5219H11.7004C12.8535 17.5219 13.8098 16.6219 13.866 15.4688L14.3441 6.13127C14.8785 5.90627 15.2441 5.42815 15.2441 4.8094V3.96565C15.2441 3.15002 14.5691 2.47502 13.7535 2.47502ZM7.67852 1.9969C7.67852 1.85627 7.79102 1.74377 7.93164 1.74377H10.0973C10.2379 1.74377 10.3504 1.85627 10.3504 1.9969V2.47502H7.67852V1.9969ZM4.02227 3.96565C4.02227 3.85315 4.10664 3.74065 4.24727 3.74065H13.7535C13.866 3.74065 13.9785 3.82502 13.9785 3.96565V4.8094C13.9785 4.92190 13.8941 5.0344 13.7535 5.0344H4.24727C4.13477 5.0344 4.02227 4.95002 4.02227 4.8094V3.96565ZM11.7285 16.2563H6.27227C5.79414 16.2563 5.40039 15.8906 5.37227 15.4125L4.95039 6.32815H13.0504L12.6004 15.4125C12.5723 15.8906 12.2066 16.2563 11.7285 16.2563Z" />
                            </svg>
                          </button>
                        </div>
                      </div>
