...
import { OrderTable } from "./OrderTable/data-table";
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-white dark:bg-gray-dark rounded-2xl shadow-sm border border-stroke dark:border-stroke-dark overflow-hidden">
                <div className="p-6 border-b border-stroke dark:border-stroke-dark flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-1 dark:bg-dark-3">
                    <div>
                        <h2 className="text-xl font-bold text-dark-2 dark:text-meta-5">Orders List</h2>
                        <p className="text-sm text-slate-400 font-medium mt-0.5">Manage and track your customer orders</p>
                    </div>
                ...
                <div className="p-0">
                    <OrderTable columns={columns} status={selectedStatus} orderCode={debouncedSearchCode} />
                </div>
            </div>
        </div>
    );
