...
import { Plus, Tag, Search, Filter, Check } from "lucide-react"
import { columns } from "./Discounts/columns"
import { DiscountDataTable } from "./Discounts/data-table"
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-400 font-medium mt-1">
                        Manage your store-wide discounts and promotions
                    </p>
                </div>
                <button
                    onClick={() => setAddModalOpen(true)}
                    className="flex items-center gap-2 px-5 py-2.5 bg-blue hover:bg-blue-dark text-white rounded-xl font-bold transition-all active:scale-95 shadow-lg shadow-blue-200 dark:shadow-none"
                >
            ...
            <div className="bg-white dark:bg-gray-dark rounded-2xl shadow-sm border border-stroke dark:border-stroke-dark overflow-hidden">
                <div className="p-6 border-b border-stroke dark:border-stroke-dark flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-1 dark:bg-dark-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-dark-2 dark:text-white tracking-tight">Active Discounts</h3>
                            <p className="text-sm text-slate-400 font-medium mt-0.5">Search and manage your discounts</p>
                        </div>
                    </div>
